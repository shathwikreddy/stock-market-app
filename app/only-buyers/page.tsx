...
import { onlyBuyersNSE, TopGainerLoserStock } from '@/lib/mockData';

export default function OnlyBuyersPage() {
        ...
        return (
            <div className="min-h-screen bg-white flex items-center justify-center">
                <div className="text-center">
                    ...
                    <p className="text-sm text-gray-500">Loading only buyers stocks...</p>
                </div>
            </div>
        );
    }
