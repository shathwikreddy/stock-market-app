...
export default function AllTimeLowPage() {
    ...
    useEffect(() => {
        ...
        // Using mock data (can be replaced with actual ATL data API)
        ...
        return (
            <div className="min-h-screen bg-white flex items-center justify-center">
                <div className="text-center">
                    ...
                    <p className="text-sm text-gray-500">Loading all time low stocks...</p>
                </div>
            </div>
        );
    }
